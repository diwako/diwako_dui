...
if (isNil "ace_interact_menu_fnc_createAction") then {
    ...
    },{!(ace_interaction_EnableTeamManagement && [_player, _target] call ace_interaction_fnc_canJoinTeam) && {_target in (units group _player) && {(_player getVariable [QGVAR(buddy), objNull]) isNotEqualTo _target}}},{},[], [0,0,0], _range] call ace_interact_menu_fnc_createAction;

    ["CAManBase", 0, ["ACE_MainActions"], _action, true] call ace_interact_menu_fnc_addActionToClass;

    _action = [QGVAR(buddy_action_remove), _labelRemove, "", {
        [_player, _target, false] call FUNC(pairBuddies);
    },{!(ace_interaction_EnableTeamManagement && [_player, _target] call ace_interaction_fnc_canJoinTeam) && {_target in (units group _player) && {(_player getVariable [QGVAR(buddy), objNull]) isEqualTo _target}}},{},[], [0,0,0], _range] call ace_interact_menu_fnc_createAction;
    ...
    _action = [QGVAR(buddy_action_team), _labelAdd, "", {
        [_player, _target] call FUNC(pairBuddies);
    },{(ace_interaction_EnableTeamManagement && [_player, _target] call ace_interaction_fnc_canJoinTeam) && {(_player getVariable [QGVAR(buddy), objNull]) isNotEqualTo _target}},{},[], [0,0,0], _range] call ace_interact_menu_fnc_createAction;

    ["CAManBase", 0, ["ACE_MainActions", "ACE_TeamManagement"], _action, true] call ace_interact_menu_fnc_addActionToClass;

    _action = [QGVAR(buddy_action_team_remove), _labelRemove, "", {
        [_player, _target, false] call FUNC(pairBuddies);
    },{(ace_interaction_EnableTeamManagement && [_player, _target] call ace_interaction_fnc_canJoinTeam) && {(_player getVariable [QGVAR(buddy), objNull]) isEqualTo _target}},{},[], [0,0,0], _range] call ace_interact_menu_fnc_createAction;
