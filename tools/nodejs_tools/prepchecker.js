...
const PREFIX = "diwako_dui";

const projectFiles = [];
const prepedFunctions = ["diwako_dui_main_fnc_roundvalue", "diwako_dui_nametags_fnc_nametagscustomfadecalculation"];
const ignoreFiles = ["addons/main/functions/fnc_fncName.sqf", "addons/main/functions/fnc_var1.sqf"]
const ignoredFiles = [];
